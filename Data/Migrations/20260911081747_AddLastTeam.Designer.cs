...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IndxCloudApi.Data.Team", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("IndxCloudApi.Data.TeamMember", b =>
                {
            ...
            modelBuilder.Entity("IndxCloudApi.Data.TeamMember", b =>
                {
                    b.HasOne("IndxCloudApi.Data.Team", "Team")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("IndxCloudApi.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
